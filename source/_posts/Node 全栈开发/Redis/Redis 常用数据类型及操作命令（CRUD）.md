...
1. 字符串类型
    - 图示：
      <img src="字符串类型.jpg" width="400px" height="auto" class="lazy-load" title="字符串类型"/>
...
1. 哈希（也叫散列）类型
    - 图示：
        <img src="哈希.jpg" width="400px" height="auto" class="lazy-load" title="哈希"/>
...
1. 列表类型
    - 图示：
      <img src="列表.jpg" width="400px" height="auto" class="lazy-load" title="列表"/>
...
1. 有序集合
    - 图示：
      <img src="有序集合.jpg" width="400px" height="auto" class="lazy-load" title="有序集合"/>
